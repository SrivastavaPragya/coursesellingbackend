...
exports.GetCategorizedCourses = exports.GetPurchasedCourseFiltered = exports.GetAllPurchasedCourse = exports.PurchaseCourse = exports.UpdateUserProfile = exports.GetUserProfile = exports.LogInUser = exports.SignUpUser = void 0;
...
const GetAllPurchasedCourse = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.user && req.user.id) {
...
const GetPurchasedCourseFiltered = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user || !req.user.id) {
        return res.status(401).json({ message: "Unauthorized" });
    }
...
exports.GetPurchasedCourseFiltered = GetPurchasedCourseFiltered;
const GetCategorizedCourses = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.user && req.user.id) {
            const user = yield Schema_1.User.findById(req.user.id);
            if (user) {
...
exports.GetCategorizedCourses = GetCategorizedCourses;
